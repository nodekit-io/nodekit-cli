...
`NodeKit-cli` se ha probado en **Mac OS X**, **Linux**, **Windows 7**y **Windows 8**.
...
Una aplicación de NodeKit con `nodekit-cli` tendrá la siguiente estructura de directorios:
