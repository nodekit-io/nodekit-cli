...
// CUSTOM CREATED for NodeKit for macOS based on iOS requirements minus ios-deploy, but to include cocoapods
...
module.exports.check_os = function () {
    // Build macOS apps available for macOS platform only, so we reject on others platforms
    return process.platform === 'darwin' ?
        Q.resolve(process.platform) :
        Q.reject('NodeKit tooling for macOS requires Apple macOS');
};
