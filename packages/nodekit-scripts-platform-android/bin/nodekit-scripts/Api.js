...
var PluginManager = require('nodekit-scripts').common.PluginManager;

var NodeKitLogger = require('nodekit-scripts').common.NodeKitLogger;
var selfEvents = require('nodekit-scripts').common.events;
...
function Api(platform, platformRootDir, events) {
    ...
    this.locations = {
        ...
        defaultNodeKitJson: path.join(self.root, 'nodekit-scripts/defaults_nodekit.json'),
        strings: path.join(self.root, 'res/values/strings.xml'),
        manifest: path.join(self.root, 'AndroidManifest.xml'),
        build: path.join(self.root, 'build'),
        // NOTE: Due to platformApi spec we need to return relative paths here
        nodekitJs: 'bin/templates/project/assets/app/nodekit.js',
...
Api.createPlatform = function (destination, config, options, events) {
    ...
    try {
        ...
        .then(function (destination) {
            var PlatformApi = require(path.resolve(destination, 'nodekit-scripts/Api'));
...
Api.prototype.addPlugin = function (plugin, installOptions) {
    ...
    return Q()
       .then(function () {
           ...
           // Since clean doesn't just clean the build, it also wipes out app, we need
...
Api.prototype.removePlugin = function (plugin, uninstallOptions) {
    ...
    if(uninstallOptions && uninstallOptions.usePlatformApp === true && this.android_studio === true) {
      uninstallOptions.usePlatformApp = false;
 ...
 * cleans out the platform app directory if called without options specified.
 *
 * @return  {Promise}  Return a promise either fulfilled, or rejected with
 *   NodeKitError.
 */
