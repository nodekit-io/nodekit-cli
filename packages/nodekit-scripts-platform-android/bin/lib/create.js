...
var AndroidManifest = require('../nodekit-scripts/lib/AndroidManifest');
...
function prepBuildFiles(projectPath) {
    var buildModule = require(path.resolve(projectPath, 'nodekit-scripts/lib/builders/builders'));
...
function copyScripts(projectPath) {
    var srcScriptsDir = path.join(ROOT, 'bin', 'nodekit-scripts');
    var destScriptsDir = path.join(projectPath, 'nodekit-scripts');
    ...
    shell.cp(path.join(ROOT, 'bin', 'lib', 'check_reqs.js'), path.join(projectPath, 'nodekit-scripts', 'lib', 'check_reqs.js'));
    shell.cp(path.join(ROOT, 'bin', 'android_sdk_version'), path.join(destScriptsDir, 'android_sdk_version'));
    shell.cp(path.join(ROOT, 'bin', 'lib', 'android_sdk_version.js'), path.join(projectPath, 'nodekit-scripts', 'lib', 'android_sdk_version.js'));
}
