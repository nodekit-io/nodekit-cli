...
function Api(platform, platformRootDir, events) {
    ...
    this.locations = {
        root: this.root,
        app: path.join(this.root, 'app'),
        platformApp: path.join(this.root, 'platform_app'),
        nodekitJson: path.join(xcodeNodeKitProj, 'nodekit.json'),
        defaultNodeKitJson: path.join(this.root, 'nodekit-scripts/defaults_nodekit.json'),
        ...
        nodekitJs: 'bin/NKNodeKit/nodekit.js',
