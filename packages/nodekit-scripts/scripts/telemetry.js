...
// https://github.com/nodekit-scripts/nodekit-discuss/pull/43

var Q = require('q');

// Google Analytics tracking code
var GA_TRACKING_CODE = 'UA-85195988-1';
...
function showPrompt() {
    ...
    var msg = 'May NodeKit anonymously report usage statistics to improve the tool over time?';
    insight.askPermission(msg, function (unused, optIn) {
        var EOL = require('os').EOL;
        if (optIn) {
            console.log(EOL + 'Thanks for opting into telemetry to help us improve nodekit.');
            track('telemetry', 'on', 'via-cli-prompt-choice', 'successful');
        } else {
            console.log(EOL + 'You have been opted out of telemetry. To change this, run: nodekit telemetry on.');
...
/**
 * Has the user ran a command of the form: `nodekit run --no-telemetry` ?
 */
