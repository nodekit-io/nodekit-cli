...
exports = module.exports = {
    ...
    get events() { return require('nodekit-scripts').common.events },
    get configparser() { return require('nodekit-scripts').common.ConfigParser },
    get PluginInfo() { return require('nodekit-scripts').common.PluginInfo },
    get NodeKitError() { return require('nodekit-scripts').common.NodeKitError }

};

addProperty(module.exports, 'plugman', './plugman/plugman');
addProperty(module.exports, 'nodekit', './nodekit-scripts/nodekit');
