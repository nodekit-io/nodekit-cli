...
Api.createPlatform = function (destinationDir, projectConfig, options, events) {
    ...
    try {
        ...
        .then(function () {
            var PlatformApi = require(path.resolve(destinationDir, 'nodekit-scripts/Api'));
...
Api.prototype.addPlugin = function (plugin, installOptions) {
    ...
    return pluginManager
        ...
        .then(function () {
            // CB-11657 Add BOM to app files here because files added by plugin
            // probably don't have it. Prepare would add BOM but it might not be called
            return require('./lib/prepare').addBOMSignature(self.locations.app);
        })
...
Api.prototype.removePlugin = function (plugin, uninstallOptions) {
    ...
    return pluginManager
        ...
        .then(function () {
            ...
            return require('./lib/prepare').addBOMToFile(path.resolve(self.locations.app, 'nodekit_plugins.js'));
        })
        // CB-11022 return non-falsy value to indicate
        // that there is no need to run prepare after
        .thenResolve(true);
