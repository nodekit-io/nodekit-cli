...
var spawn = require('nodekit-scripts').common.superspawn.spawn;
var NodeKitError = require('nodekit-scripts').common.NodeKitError;

var ConfigParser, MSBuildTools, Version;
try {
    ConfigParser = require('../../template/nodekit-scripts/lib/ConfigParser');
    MSBuildTools = require('../../template/nodekit-scripts/lib/MSBuildTools');
    Version = require('../../template/nodekit-scripts/lib/Version');
} catch (ex) {
    ...
    .then(function (msbuildToolsVersions) {
        ...
        return appropriateVersion ?
            ...
            Q.reject('MSBuild tools v.' + shortenVersion(msbuildRequiredVersion) + ' not found. ' +
                ...
                ' from https://app.visualstudio.com/downloads/download-visual-studio-vs');
    });
};
