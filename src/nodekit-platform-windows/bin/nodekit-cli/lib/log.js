...
module.exports.help = function() {
    console.log();
    console.log('Usage: ' + path.relative(process.cwd(), path.join(platformRoot, 'nodekit-cli', 'log [options]')));
    ...
    console.log();
    console.log('  Example: ' + path.relative(process.cwd(), path.join(platformRoot, 'nodekit-cli', 'log --dump --mins 5')));
    process.exit(0);
};
