...
var spawn = require('nodekit-cli')['nodekit-cli-common'].superspawn.spawn;
var NodeKitError = require('nodekit-cli')['nodekit-cli-common'].NodeKitError;

var ConfigParser, MSBuildTools, Version;
try {
    ConfigParser = require('../../template/nodekit-cli/lib/ConfigParser');
    MSBuildTools = require('../../template/nodekit-cli/lib/MSBuildTools');
    Version = require('../../template/nodekit-cli/lib/Version');
} catch (ex) {
