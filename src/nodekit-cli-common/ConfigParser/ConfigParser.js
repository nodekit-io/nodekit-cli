...
var et = require('elementtree'),
    xml_json_helpers = require('../util/xml-json-helpers'),
    NodeKitError = require('../NodeKitError/NodeKitError'),
    fs = require('fs'),
    events = require('../events');

/** Wraps a nodekit.json file */
    ...
    */
    ...
    getPlugin: function(id){
        ...
        if (null === pluginElement) {
            ...
            if(legacyFeature){
                 events.emit('log', 'Found deprecated feature entry for ' + id +' in nodekit.json.');
    ...
    write:function() {
        ...
        xml_json_helpers.writeJsonFromXml(this.path, this.doc)
    }
};
