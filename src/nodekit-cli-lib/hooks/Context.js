...
function Context(hook, opts) {
    ...
    this.nodekit = require('../nodekit-cli/nodekit');
}
...
var compatMap = {
    '../configparser/ConfigParser': function () {
        return require('nodekit-cli')['nodekit-cli-common'].ConfigParser;
    },
    '../util/xml-helpers': function () {
        return require('nodekit-cli')['nodekit-cli-common'].xmlHelpers;
    }
};
