...
function updateConfigFile(sourceConfig, configMunger, locations) {
    events.emit('verbose', 'Generating platform-specific nodekit.json from defaults for iOS at ' + locations.nodekitJson);
    ...
    events.emit('verbose', 'Merging project\'s nodekit.json into platform-specific iOS nodekit.json');
...
function updateProject(platformConfig, locations) {
    ...
    // replace Info.plist ATS entries according to <access> and <allow-navigation> nodekit.json entries
    ...
    return handleBuildSettings(platformConfig, locations, infoPlist).then(function() {
        if (name == originalName) {
            ...
            var errorString = 
            'The product name change (<name> tag) in nodekit.json is not supported dynamically.\n' +
 ...
 *     ]
 * 
 * @param  {Array<Object>} splashScreens         splash screens as defined in nodekit.json for this platform
 ...
 * @param  {Object} projectConfig      The project's nodekit.json 
 * @param  {Object} locations          A dictionary containing useful location paths
 */
