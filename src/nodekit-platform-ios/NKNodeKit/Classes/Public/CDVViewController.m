...
@synthesize appFolderName, startPage, initialized, openURL, baseUserAgent;
...
- (NSURL*)appUrl
{
    ...
    } else if([self.appFolderName hasSuffix:@".bundle"]){
        // app folder is actually a bundle
        NSBundle* bundle = [NSBundle bundleWithPath:self.appFolderName];
        appURL = [bundle URLForResource:self.startPage withExtension:nil];
    } else if([self.appFolderName hasSuffix:@".framework"]){
        // app folder is actually a framework
        NSBundle* bundle = [NSBundle bundleWithPath:self.appFolderName];
        appURL = [bundle URLForResource:self.startPage withExtension:nil];
    } else {
...
- (void)viewDidLoad
{
    ...
    [CDVUserAgentUtil acquireLock:^(NSInteger lockToken) {
        ...
        if (appURL) {
            ...
            NSString* loadErr = [NSString stringWithFormat:@"ERROR: Start Page at '%@/%@' was not found.", self.appFolderName, self.startPage];
            NSLog(@"%@", loadErr);
