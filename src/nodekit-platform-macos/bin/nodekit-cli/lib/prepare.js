...
function updateConfigFile(sourceConfig, configMunger, locations) {
    events.emit('verbose', 'Generating nodekit.json from defaults for platform "osx"');
...
function updateApp(nodekitProject, destinations) {
    ...
    if (fs.existsSync(merges_path)) {
        events.emit('verbose', 'Found "merges" for osx platform. Copying over existing "app" files.');
        var overrides = path.join(merges_path, '*');
        shell.cp('-rf', overrides, destinations.app);
    }
}
