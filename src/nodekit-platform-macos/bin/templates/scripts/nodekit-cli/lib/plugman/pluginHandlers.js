...
var handlers = {
    ...
    'asset':{
        install:function(obj, plugin, project, options) {
            ...
            var app = options.usePlatformApp ? project.platformApp : project.app;

            copyFile(plugin.dir, obj.src, app, obj.target);
        },
        uninstall:function(obj, plugin, project, options) {
    ...
    'js-module': {
        install: function (obj, plugin, project, options) {
            ...
            var app = options.usePlatformApp ? project.platformApp : project.app;
            var moduleDestination = path.resolve(app, 'plugins', plugin.id, obj.src);
        ...
        uninstall: function (obj, plugin, project, options) {
            ...
            var app = options.usePlatformApp ? project.platformApp : project.app;
            removeFileAndParents(app, pluginRelativePath);
        }
    }
};
