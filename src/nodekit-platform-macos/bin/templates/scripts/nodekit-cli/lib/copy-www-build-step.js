...
// This script copies the app directory into the Xcode project.
...
var path = require('path'),
    ...
    dstAppDir = path.join(dstDir, 'app');
...
if(code !== 0) {
    console.error('Error occurred on copying app. Code: ' + code);
    process.exit(3);
}
