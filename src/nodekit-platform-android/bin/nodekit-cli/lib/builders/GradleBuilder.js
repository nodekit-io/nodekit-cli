...
GradleBuilder.prototype.prepBuildFiles = function() {
    ...
    var pluginBuildGradle = path.join(this.root, 'nodekit-cli', 'lib', 'plugin-build.gradle');
    ...
    var insertExclude = function(p) {
          ...
          if(projectGradleFile.indexOf('NKNodeKit') != -1) {
            depsList += '{\n        exclude module:("NKNodeKit")\n    }\n';
          }
          else {
            depsList +='\n';
          }
...
GradleBuilder.prototype.prepEnv = function(opts) {
    ...
    .then(function() {
        ...
        /*jshint -W069 */
        var distributionUrl = process.env['NODEKIT_ANDROID_GRADLE_DISTRIBUTION_URL'] || 'https\\://services.gradle.org/distributions/gradle-2.14.1-all.zip';
        /*jshint +W069 */
