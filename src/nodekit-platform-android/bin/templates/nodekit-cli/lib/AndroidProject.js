...
function AndroidProject(projectDir) {
    ...
    this.platformApp = path.join(this.projectDir, 'platform_app');
    this.app = path.join(this.projectDir, 'assets/app');
    if(AndroidStudio.isAndroidStudioProject(projectDir) === true) {
      this.app = path.join(this.projectDir, 'app/src/main/assets/app');
    }
}
